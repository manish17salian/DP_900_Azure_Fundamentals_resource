...
- Transactional data processing
    ...
    - OLTP systems shd enforce ACID (Atomicity(entire transction happens at once or nothing happens),Consistency,Isolation,Durability (persisted). 
        	: Suitable for Optimised Read and Write operations.
...
- SQL Server on an Azure Virtual Machines running Windows is the only option that supports all the SQL Server features in the cloud

    #### Azure SQL VM Installation
    - That absolutely NO code will have to change when migrating
...
- Automated software update management, backups, and other maintenance tasks
- User has full control over security and resource allocation for your databases
...
- It is compatible with SQL Server 2016
- Azure SQL managed instance does not supports user-created backups. 
